...
import './LuxuryTourService.css';
import Image from '../../../images/luxuryLeft.jpg';

const LuxuryTourService = () => {
    return (
        <section className="container luxury-tour">
            <div className="lt-info">
                <div className="lt-info-content">
                    <h1>Luxury tours and expeditions</h1>
...
export default LuxuryTourService;